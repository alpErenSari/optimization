...
%         keyboard;
        ...
        elseif(strcmp(unconstrained_solver, 'steepest_descent'))
            [x_sol, k, res] = steepest_descent(J_aug, J_aug_grad, x0, 20, eps);
         elseif(strcmp(unconstrained_solver, 'rank_2_correction'))   
            [x_sol, k] = rank_2(J_aug, J_aug_grad, x0, H0, 20, eps);
        elseif(strcmp(unconstrained_solver, 'newton_method'))   
            [x_sol, k, res] = newton(J_aug, J_aug_grad, J_aug_hess, x0, 20, eps);
        end
